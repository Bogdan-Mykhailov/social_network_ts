  ...
  _state: {
    ...
    dialogsPage: {
      dialogsData: [
        ...
        {id: 5, name: 'Pikachu', avatar: 'https://i.pinimg.com/originals/80/d8/e0/80d8e0232d36605e4fb8697353d4a4f2.gif'},
      ],
      messageData: [
        {
          id: 1,
